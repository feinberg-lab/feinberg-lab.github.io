    ...
    content:
      ...
      text: |
        ...
        <div class="lab-style-block">
          ...
          <å>The NexGen 7T system currently has the highest-performance head gradients in a human 7T MRI scanner, creating a new operating regime for diffusion MRI. This regime supports ultra-high b-values while preserving SNR and spatial resolution. It also provides increased sensitivity to restricted and intra-axonal diffusion, reducing uncertainty in fiber orientation, and enabling advanced microstructural modeling frameworks.</p>
